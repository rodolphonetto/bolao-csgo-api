...
exports.validateBet = function(data) {
  ...
  if (Validator.isEmpty(resultA)) {
    errors.resultAEmpty =
      'Campo resultado time A em branco, preencha o campo do placar com 0 em caso de derrota';
  }
  ...
  if (Validator.isEmpty(resultB)) {
    errors.resultBEmpty =
      'Campo resultado time B em branco, preencha o campo do placar com 0 em caso de derrota';
  }
